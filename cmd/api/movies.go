...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	input.Title, _ = app.readString(qs, "title", "")
	input.Genres, _ = app.readCSV(qs, "genres", []string{})
	input.Filters.Page, _ = app.readInt(qs, "page", 1, v)
	input.Filters.PageSize, _ = app.readInt(qs, "page_size", 20, v)
	input.Filters.Sort, _ = app.readString(qs, "sort", "id")
